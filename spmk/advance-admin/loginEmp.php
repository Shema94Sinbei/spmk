...
<body> <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0; background-color: #0089FF;" >
                ...
                <a href="loginAd.php" class="btn btn-info" title="Log Masuk"> Pentadbir Sistem</a>
...
<style="background-color: #3669ad;">
    <div class="container">
        <div class="row text-center " style="padding-top:112px;">
            <div class="col-md-12">
			 ...
			 <h4 align="center"><b>SISTEM PENGURUSAN MAKLUMAT KAKITANGAN</b></h4>
			          </div>
        </div>
         <div class="row ">
                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                            ...
                            <div class="panel-body">
                                <form role="form" action="processEmp.php" method="POST">
                                    <hr />
                                    ...
                                    <div class="form-group">
                                        <span class="pull-right">
                                                   <a href="register.php" style="color:black;">Belum Daftar ? </a> 
                                            </span>
                                        </div>
